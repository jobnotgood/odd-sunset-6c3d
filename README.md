...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/odd-sunset-6c3d)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/odd-sunset-6c3d#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/odd-sunset-6c3d
```

A live public deployment of this template is available at [https://odd-sunset-6c3d.templates.workers.dev](https://odd-sunset-6c3d.templates.workers.dev)
